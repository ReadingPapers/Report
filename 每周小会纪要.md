## 已迁移至谷歌云盘private share，请联系组织者加入
---
### 2024年
确定投稿接受后再打[x]

- 10.24 张宇
  - 张宇 - 分享了两篇视觉语言模型在FER应用上的工作，交流了目前VLM IN FER领域存在的一些问题。-[paper1](https://arxiv.org/abs/2409.08598)-[paper2](https://arxiv.org/abs/2303.00193) -[PPT](https://docs.google.com/presentation/d/1NSNaLHO3PDvvBMJX5yYZ6gBxi9EHpPFq/edit#slide=id.p4)


- 10.11 徐赟博 何艺超
  - 徐赟博 - 分享了一篇general的多模态工作，研究量化视觉特征的能力以及为下游任务选择最优视觉特征的方式。-[paper](https://openreview.net/pdf?id=SZm3hxmksx) -[PPT](https://docs.google.com/presentation/d/1yAI4qs3ogs0NSlcK2qE14btdze3aG0D_/edit?rtpof=true)
  - 何艺超 - 分享了情感大模型emotion llama的数据集制作流程以及模型的实现细节 -[paper](https://arxiv.org/pdf/2406.11161) -[PPT](https://docs.google.com/presentation/d/1wGc2lzZSpC7oWc4KBvvmmGzflUF9eNyP/edit?usp=drive_web&ouid=108523051968570972506&rtpof=true)
