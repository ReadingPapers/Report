...
> >论文简述:
> >
> >论文简述：本文介绍了Face Transformer，这是一种利用Transformer架构实现精确人脸交换的网络。通过学习源脸和目标脸之间的语义感知对应，该模型能够在保留源身份细节和目标属性的同时，进行准确的面部交换。这种高质量的语义对应关系使得源身份信息的传递更加平滑准确，同时最小化修改目标脸的形状和表情。此外，Face Transformer还融合了多尺度变换机制，以保留丰富的面部细节。
> 
