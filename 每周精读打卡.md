...
> > 
> >[2025-08-31]-[戴逦]-[Sentimentogram: A Personalized Subtitle System Using Multi-modal Emotion Recognition and Visualization]
> >
> >论文简述：本文提出Sentimentogram，一个基于多模态情感识别的个性化字幕系统。该系统利用Wav2Vec2提取声学特征、BERT提取语言特征，并通过自注意力与跨模态注意力机制进行融合，从而识别情绪并映射至VAD空间。字幕的颜色、大小和样式随情绪动态变化，同时结合用户年龄、文化背景和播放条件进行个性化调整。实验证明该方法在IEMOCAP数据集上取得了与SOTA方法相当的结果。
>
