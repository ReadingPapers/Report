...
> >
> > [2024-12-08]-[张雪松]-[End-to-End Navigation with Vision-Language Models: Transforming Spatial Reasoning into Question-Answering]()
> > <img width="512" alt="image" src="https://github.com/user-attachments/assets/6db59b31-2309-432c-9504-0e596944d3f8">
> >
> >论文简述:本文将视觉语言模型（VLM）用于端到端导航任务。通过将导航问题转化为视觉问答任务，VLMnav无需额外训练即可实现零样本导航。方法核心包括动作prompt、投影注释和详细的文本提示，结合深度信息生成可导航路径并指导机器人进行动作选择，实验在ObjectNav和GOAT基准上验证了其导航精度和效率的提升。
> >
