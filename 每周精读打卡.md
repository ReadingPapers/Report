...
> >
> >[2026-01-03]-[程浩]-[本周未精读] \
>> [2025-12-28]-[陈乾]-[A multimodal fusion model for real-time environment emotion recognition using audiovisual-textual features]
>>
>> <img width="512" height="512" alt="image" src="https://github.com/2003-0224/PapperImage/blob/main/0a2929d58558284c76622d29ea95490a.png" />
>>
>> 论文简述：实时环境感知中的多模态融合旨在通过联合利用视觉、雷达等多源传感器信息，提高复杂动态场景下的感知精度与鲁棒性，但传统单模态或简单拼接式融合方法难以兼顾实时性与多模态互补性。本文提出一种面向实时环境感知的多模态融合模型，通过统一的特征编码与层次化融合机制，在特征层与决策层充分建模不同模态之间的互补关系，有效缓解单一传感器受噪声、遮挡或环境变化带来的性能退化问题。该模型在保证低延迟的前提下，引入轻量化融合模块，实现对多模态信息的高效协同感知。实验结果表明，该方法在多种复杂环境下均优于传统融合策略，在感知精度与实时性之间取得了更优平衡，验证了其在实际实时环境感知任务中的有效性与应用潜力。
>> 
>> [2025-12-28]-[贾朋]-[本周未精读]
>> 
