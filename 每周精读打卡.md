...
> > 具体来说，（1）编码所有历史view的成本是巨大的，本文提出了hierarchical vision transformer能够逐步学习全景图中每一个view之间的空间关系，然后建模跨越全景图的基于历史observation的时间关系（2）本文提出了SAP训练方式，使得模型能够端到端的使用强化学习的方式训练大规模的transformer。
