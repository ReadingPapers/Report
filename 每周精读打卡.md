...
> >
> > 论文简述：论文中提到以往的方法通常讲多模态信息是为等质量的信息，并且采用对称架构进行多模态融合，而实际上使用对称架构在处理不均匀的模态信息时难以准确识别对话情感。因此本文提出CMATH模型结构，如图所示。其实该结构与之前SDT[https://ieeexplore.ieee.org/abstract/document/10109845]的思路有些类似的地方，就是讲。 主要就是模态重建以及自蒸馏方法
> 
